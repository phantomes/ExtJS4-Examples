 ...
 <script type="text/javascript">
 	...
 	Ext.onReady(function(){
 		...
 		var bookStore=Ext.create('Ext.data.Store',{
 			...
 			proxy:{
 				type:'ajax',
 				url:path+'/bookext.do?method?=getBookList',
 				reader:{
	 				type:'xml',
 		...
 		var bookGrid=new Ext.grid.Panel({
 			...
 			columns:[
 			         ...
 			         {text:'简介',width:80,dataIndex:'brief',sortable:true}
 			         ]
 		});
 		...
 		function deleteBooks(bookList){
 			...
 			Ext.Ajax.request({
 				url:path+'/bookext.do?method=deleteBooks',
 		...
 		function loadForm(bookId){
 			bookForm.form.load({
 				waitMsg:'正在加载数据请稍候',
 				waitTitle:'提示',
 				url:path+'/bookext.do?method=getBookById',
